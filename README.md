...
- **Adding ability for users to add videos** to their KindAct creations... and adding the ability to add videos in comments section if someone else has implemented this kind act and would like to share their experience with it.
